...
public class JImageEditor extends javax.swing.JPanel {
    ...
    private static class ImageFilter extends javax.swing.filechooser.FileFilter {
        ...
        public boolean accept(java.io.File f) {
            if (f.isDirectory()) {
                ...
                if (ipos >= 0) {
                    String sExt = sFileName.substring(ipos).toLowerCase();
                    return (".gif".equals(sExt) || 
                            ".png".equals(sExt) ||
                            ".jpg".equals(sExt) ||
                            ".jpeg".equals(sExt));
                } else {
        ...
        public String getDescription() {
            return LocalRes.getIntString("label.imagefiles");
        }      
    }
    ...
    private void initComponents() {
        ...
        m_jbtnopen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/fileopen.png")));
        ...
        m_jbtnclose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/fileclose.png")));
        ...
        m_jbtnzoomin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/viewmag+.png")));
        ...
        m_jPercent.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("Button.darkShadow")), new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 4, 1, 4))));
        m_jPercent.setOpaque(true);
        jPanel2.add(m_jPercent);

        m_jbtnzoomout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/viewmag-.png")));
