...
public class JMessageDialog extends javax.swing.JDialog {
    ...
    public static void showMessage(Component parent, MessageInf inf) {
        ...
        if (inf.getCause() == null) {
            ...
            if (inf.getCause() instanceof Throwable) {
                ...
                sb.append(": ");
                sb.append(((Throwable)inf.getCause()).getMessage());
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jscrException.setBounds(10, 120, 280, 110);
        ...
        jlblIcon.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(10, 10, 10, 10)));
        getContentPane().add(jlblIcon, java.awt.BorderLayout.WEST);

        java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
        setBounds((screenSize.width-381)/2, (screenSize.height-184)/2, 381, 184);
