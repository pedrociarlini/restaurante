...
public class JNavigator extends javax.swing.JPanel implements BrowseListener, StateListener {
    ...
    public JNavigator(BrowsableEditableData bd, Vectorer vec, ComparatorCreator cc, int iButtons) {
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnFirst.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/2leftarrow.png")));
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnPrev.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/1leftarrow.png")));
        ...
        jbtnRefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/1downarrow.png")));
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/1rightarrow.png")));
        ...
        if (iButtons == BUTTONS_ALL) {
            ...
            jbtnLast.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/2rightarrow.png")));
        ...
        if (bd.canLoadData()) {
            ...
            jbtnReload.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/reload.png")));
        ...
        if (vec == null) {
            ...
            jbtnFind.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/search.png")));
        ...
        if (m_cc != null) {
            ...
            jbtnSort.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/sort_incr.png")));
