...
public class ListProviderECreator implements ListProvider {
    ...
    public ListProviderECreator(SentenceList sent, EditorCreator prov) {
        this.sent = sent;
        this.prov = prov;
        params = null;
    }
    public ListProviderECreator(TableDefinition table) {        
