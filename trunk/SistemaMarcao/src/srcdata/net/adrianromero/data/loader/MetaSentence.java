...
public class MetaSentence extends JDBCSentence {
    ...
    public MetaSentence(Connection c, String sSentence, SerializerWrite serwrite, SerializerRead serread) {
        super(c);
        m_sSentence = sSentence;
        m_SerWrite = serwrite;
        m_SerRead = serread;
    }
    public MetaSentence(Connection c, String sSentence, SerializerRead serread) {
        this(c, sSentence, null, serread);
    }
...
//       }
    ...
    public DataResultSet openExec(Object params) throws BasicException {
        ...
        try {
            DatabaseMetaData db = m_c.getMetaData();
