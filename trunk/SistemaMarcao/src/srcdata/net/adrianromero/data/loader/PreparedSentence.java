 ...
 * Sentence.java
 *
 * Created on 7 de octubre de 2002, 22:49
 */
...
public class PreparedSentence extends JDBCSentence {
    ...
    public PreparedSentence(Connection c, String sentence, SerializerWrite serwrite, SerializerRead serread) {         
        super(c);
        m_sentence = sentence;        
        m_SerWrite = serwrite;
        m_SerRead = serread;
    ...
    public PreparedSentence(Connection c, String sentence, SerializerWrite serwrite) {         
        this(c, sentence, serwrite, null);
    }
    public PreparedSentence(Connection c, String sentence) {         
...
//        }
    ...
    public DataResultSet openExec(Object params) throws BasicException {
        ...
        try {
            if (m_Stmt == null) {                      
                // Ya tenemos conexion y sentencia
                m_Stmt = m_c.prepareStatement(m_sentence);
            }      
