...
public class VectorerBasic implements Vectorer {
    ...
    public String[] getValues(Object obj) throws BasicException {
        ...
        for (int i = 0; i < m_aiIndex.length; i++) {
            asvalues[i] = m_aFormats[i].formatValue(avalues[m_aiIndex[i]]);
        }
...
//    public String[] getValues(Object obj) throws BasicException {
//        Object[] avalues = (Object[]) obj;
//        String[] asvalues = new String[m_asHeaders.length];
//        int ivalues = 0;
//        for (int i = 0; i < m_aFormats.length; i++) {
//            if (m_aFormats[i] != null) {
//                asvalues[ivalues++] = m_aFormats[i].formatValue(avalues[i]);
//            }
//        }
//        
//        return asvalues;
