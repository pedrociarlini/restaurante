...
public class SequenceForMySQL extends BaseSentence {
    ...
    public SequenceForMySQL(Connection cnt, String sSeqTable, SerializerRead serread) {
        
        sent1 = new StaticSentence(cnt, "UPDATE " + sSeqTable + " SET ID = LAST_INSERT_ID(ID + 1)");
        sent2 = new StaticSentence(cnt, "SELECT LAST_INSERT_ID()", null, serread);
    }
