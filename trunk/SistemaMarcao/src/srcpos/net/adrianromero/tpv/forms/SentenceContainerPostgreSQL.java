...
public class SentenceContainerPostgreSQL extends SentenceContainer {
    ...
    public void init(Connection cnt) {
        ...
        m_nextticketindex = new StaticSentence(cnt, "SELECT NEXTVAL('TICKETSNUM')", null, SerializerReadInteger.INSTANCE);               
        m_nextreservation = new StaticSentence(cnt, "SELECT NEXTVAL('RESERVATIONSNUM')", null, SerializerReadInteger.INSTANCE);    
        m_nextstockdiary = new StaticSentence(cnt, "SELECT NEXTVAL('STOCKDIARYNUM')", null, SerializerReadInteger.INSTANCE);    
        m_nextpayment = new StaticSentence(cnt, "SELECT NEXTVAL('PAYMENTSNUM')", null, SerializerReadInteger.INSTANCE);    
