...
public class DataLogicSystemOracle extends DataLogicSystem {
    ...
    public void init(Connection cnt) {
        ...
        m_sInitScript = "/net/adrianromero/tpv/data/scriptoracle";
        ...
        m_nextclosedcash = new StaticSentence(cnt, "SELECT CLOSEDCASHNUM.NEXTVAL FROM DUAL", null, SerializerReadInteger.INSTANCE);        
    }  
}
