...
public class DataLogicSystemPostgreSQL extends DataLogicSystem {
    ...
    public void init(Connection cnt) {
        ...
        m_sInitScript = "/net/adrianromero/tpv/data/scriptpostgresql";
        ...
        m_nextclosedcash = new StaticSentence(cnt, "SELECT NEXTVAL('CLOSEDCASHNUM')", null, SerializerReadInteger.INSTANCE);    
