...
public class SentenceContainerHSQLDB extends SentenceContainer {
    
    /** Creates a new instance of SentenceContainerHSQLDB */
    public SentenceContainerHSQLDB() {
    }
    ...
    public void init(Connection cnt) {
        ...
        m_nextticketindex = new StaticSentence(cnt, "CALL NEXT VALUE FOR TICKETSNUM", null, SerializerReadInteger.INSTANCE);             
        m_nextreservation = new StaticSentence(cnt, "CALL NEXT VALUE FOR RESERVATIONSNUM", null, SerializerReadInteger.INSTANCE);           
        m_nextstockdiary = new StaticSentence(cnt, "CALL NEXT VALUE FOR STOCKDIARYNUM", null, SerializerReadInteger.INSTANCE);   
        m_nextpayment = new StaticSentence(cnt, "CALL NEXT VALUE FOR PAYMENTSNUM", null, SerializerReadInteger.INSTANCE);   
