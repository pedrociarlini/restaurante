...
public class JPaymentSelect extends javax.swing.JDialog 
    ...
    private String init(AppView app, TicketInfo ticket) {
        ...
        m_sTransaction = Integer.toString(m_ticket.getId());
        
        m_ticket.setPayment(null); // inicializo el pago
        ...
        if (m_dTotal > 0.0) { 
            // Entrada de dinero
            addTabPayment(new JPaymentCashPos(this), "tab.cash", "/net/adrianromero/images/cash.png");
            addTabPayment(new JPaymentCheque(this), "tab.cheque", "/net/adrianromero/images/desktop.png");
            addTabPayment(new JPaymentPaper(this, "paperin"), "tab.paper", "/net/adrianromero/images/knotes.png");            
            addTabPayment(new JPaymentTicket(this), "tab.ticket", "/net/adrianromero/images/kontact.png");
            addTabPayment(new JPaymentMagcard(app, this), "tab.magcard", "/net/adrianromero/images/vcard.png");
            addTabPayment(new JPaymentFree(this), "tab.free", "/net/adrianromero/images/package_toys.png");
        } else { 
            // devoluciones...
            addTabPayment(new JPaymentRefund(this, "cashrefund"), "tab.cashrefund", "/net/adrianromero/images/cash.png");
            addTabPayment(new JPaymentRefund(this, "chequerefund"), "tab.chequerefund", "/net/adrianromero/images/desktop.png");
            addTabPayment(new JPaymentRefund(this, "paperout"), "tab.paper", "/net/adrianromero/images/knotes.png");            
            addTabPayment(new JPaymentMagcard(app, this), "tab.magcard", "/net/adrianromero/images/vcard.png");
    ...
    private void addTabPayment(JPaymentInterface tab, String sIntString, String sIconRes) {
    ...
    private void disposeOK(String sresourcename) {
        ...
        if (returnPayment != null) {
            ...
            m_ticket.setPayment(m_aPaymentInfo.getPaymentList());
    ...
    private void initComponents() {
        ...
        m_jTotalEuros.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("Button.darkShadow")), new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 4, 1, 4))));
        ...
        m_jLblRemainingEuros.setFont(new java.awt.Font("Dialog", 1, 12));
        ...
        m_jRemaininglEuros.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("Button.darkShadow")), new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 4, 1, 4))));
        ...
        m_jButtonAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/btnplus.png")));
        ...
        m_jButtonRemove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/btnminus.png")));
        ...
        m_jTabPayment.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(5, 5, 5, 5)));
        ...
        m_jButtonPrint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/fileprint.png")));
        ...
        m_jButtonOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/button_ok.png")));
        ...
        m_jButtonCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/button_cancel.png")));
        ...
        setBounds((screenSize.width-598)/2, (screenSize.height-467)/2, 598, 467);
    }
