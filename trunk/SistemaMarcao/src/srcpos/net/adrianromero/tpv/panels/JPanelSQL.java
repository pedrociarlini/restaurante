...
import net.adrianromero.data.loader.MetaSentence;
...
public class JPanelSQL  extends JPanel implements JPanelView {
    ...
    public JPanelSQL(AppView oApp) {
        ...
        SQLDatabase db = new SQLDatabase("Tina POS database");
        
        try {
            BaseSentence sent = new MetaSentence(m_App.getConnection(), "getTables"
            ...
            sent = new MetaSentence(m_App.getConnection(), "getColumns"
        ...
        try {
            m_App.getConnection().setAutoCommit(true);
    ...
    private void transactButtons() {
        try {
            boolean b = m_App.getConnection().getAutoCommit();
            m_jbegintrans.setEnabled(b);
            m_jcommit.setEnabled(!b);
            m_jrollback.setEnabled(!b);
        } catch (SQLException e) {
            m_jbegintrans.setEnabled(false);
            m_jcommit.setEnabled(false);
            m_jrollback.setEnabled(false);
        } 
    }
    ...
    private void initComponents() {
        ...
        m_jForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/1rightarrow.png")));
        ...
        m_jBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/1leftarrow.png")));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/editnew.png")));
        ...
        m_jtabdelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/editdelete.png")));
        ...
        add(m_jbegintrans);
        m_jbegintrans.setBounds(210, 10, 55, 23);
        ...
        add(m_jcommit);
        m_jcommit.setBounds(290, 10, 65, 23);
...
// TODO add your handling code here:
        ...
        try {
            m_App.getConnection().setAutoCommit(false);
        } catch (SQLException e) {
        }
        transactButtons();
...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        BaseSentence sent = new StaticSentence(m_App.getConnection(), m_jtxtSQL.getText());
