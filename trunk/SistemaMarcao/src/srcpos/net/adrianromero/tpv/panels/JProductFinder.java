...
public class JProductFinder extends javax.swing.JDialog {
    ...
    private ProductInfoExt init(AppView app) {
        ...
        ProductFilterSales jproductfilter = new ProductFilterSales(app);
        jproductfilter.activate();
        m_jProductSelect.add(jproductfilter, BorderLayout.CENTER);
        
        lpr = new ListProviderECreator(app.lookupDataLogic(SentenceContainer.class).getProductList(), jproductfilter);   
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/launch.png")));
