...
public class PaymentsModel {
    ...
    public static PaymentsModel loadInstance(AppView app) throws BasicException {
        ...
        // Pagos
        Object[] valtickets = (Object []) new StaticSentence(app.getConnection()
        ...
        List l = new StaticSentence(app.getConnection()            
        ...
        // Ventas
        Object[] recsales = (Object []) new StaticSentence(app.getConnection(),
        ...
        List<SalesLine> asales = new StaticSentence(app.getConnection()
                ,"SELECT TAXES.NAME, " +
                "SUM(UNITS * PRICE), " +
                "SUM(PRODUCTSOUT.UNITS * PRODUCTSOUT.PRICE * (1 + PRODUCTSOUT.TAXRATE)) " +
