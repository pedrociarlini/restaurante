...
-- Tina POS Database upgrade script for MySQL from version 0.0.16 to 0.0.17
-- v0.0.17
...
ALTER TABLE PRODUCTS ADD COLUMN ISCOM BIT NOT NULL;

ALTER TABLE PRODUCTSOUT ADD COLUMN NAME VARCHAR(100);
ALTER TABLE PRODUCTSOUT ADD COLUMN ISCOM BIT;
