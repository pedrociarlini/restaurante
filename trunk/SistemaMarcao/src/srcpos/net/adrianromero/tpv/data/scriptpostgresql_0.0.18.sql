...
-- Tina POS Database upgrade script for PostgreSQL from version 0.0.18 to 0.0.19
-- v0.0.19
...
ALTER TABLE STOCKCURRENT ADD COLUMN STOCKSECURITY DOUBLE PRECISION;
ALTER TABLE STOCKCURRENT ADD COLUMN STOCKMAXIMUM DOUBLE PRECISION;

ALTER TABLE STOCKCURRENT ADD CONSTRAINT STOCKCURRENT_FK_2 FOREIGN KEY (LOCATION) REFERENCES LOCATIONS(ID);
ALTER TABLE STOCKCURRENT DROP CONSTRAINT stockcurrent_pkey;
