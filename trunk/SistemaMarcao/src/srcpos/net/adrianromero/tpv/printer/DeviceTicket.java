...
package net.adrianromero.tpv.printer;

import java.util.*;
import javax.swing.JComponent;
import net.adrianromero.tpv.forms.AppViewConnection;

import net.adrianromero.tpv.printer.escpos.*;
import net.adrianromero.tpv.printer.javapos.DeviceDisplayJavaPOS;
import net.adrianromero.tpv.printer.javapos.DeviceFiscalPrinterJavaPOS;
import net.adrianromero.tpv.printer.javapos.DevicePrinterJavaPOS;
import net.adrianromero.tpv.printer.printer.*;
...
public class DeviceTicket {
    ...
    public DeviceTicket(AppViewConnection app){
        
        PrinterWritterPool pws = new PrinterWritterPool();
        
        // La impresora fiscal
        StringParser sf = new StringParser(app.getProperty("machine.fiscalprinter"));
        ...
        // El visor
        StringParser sd = new StringParser(app.getProperty("machine.display"));
        ...
        String sprinter = app.getProperty("machine.printer");
...
//        }
    ...
    private static class PrinterWritterPool {
        ...
        public PrinterWritter getPrinterWritter(String con, String port) throws TicketPrinterException {
            ...
            if (pw == null) {
                 if ("serial".equals(con)) {
                    pw = new PrinterWritterComm(port);
                    m_apool.put(skey, pw);
                } else if ("rxtx".equals(con)) {
    ...
    public void writeTimeVisor(String sLine1) {
        m_devicedisplay.writeTimeVisor(sLine1);
    }
