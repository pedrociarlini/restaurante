...
public class PrinterWritterComm extends PrinterWritter /* implements SerialPortEventListener */ {
    ...
    public void daemonWrite(byte[] data) {
        try {  
            if (m_out == null) {
                ...
                m_CommPortPrinter = m_PortIdPrinter.open("TinaPOS", 2000); // Abrimos el puerto       
