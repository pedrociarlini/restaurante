...
public class JReportTaxes extends JPanelReport {
    ...
    public JReportTaxes(AppView oApp) {
        super(oApp);
    }
    ...
    protected String getReport() {
        return "/net/adrianromero/reports/taxes";
    }
    ...
    protected BaseSentence getSentence() {
        return new StaticSentence(m_App.getConnection()
            , new QBFBuilder(
                ...
                "SUM(PRODUCTSOUT.UNITS * PRODUCTSOUT.PRICE * (PRODUCTSOUT.TAXRATE)) AS TOTALTAXES " +
            ...
            , new SerializerReadBasic(new Datas[] {Datas.INT, Datas.STRING, Datas.DOUBLE, Datas.DOUBLE}));
    }
