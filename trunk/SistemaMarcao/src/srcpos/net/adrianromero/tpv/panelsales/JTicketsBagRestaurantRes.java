...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    private SentenceFind sentrescounter;
    ...
    public JTicketsBagRestaurantRes(AppView oApp, JTicketsBagRestaurantMap restaurantmap) {
        ...
        sentrescounter = oApp.lookupDataLogic(SentenceContainer.class).getNextReservation();
        
        SentenceList sentload = new StaticSentence(oApp.getConnection()
        ...
        TableDefinition treservations = new TableDefinition(oApp.getConnection(),
            "RESERVATIONS"
            , new int[] {0}
        ...
        ListProvider lpr = new ListProviderECreator(sentload, new MyDateFilter());            
    ...
    public Object createValue() throws BasicException {
        ...
        res[0] = m_iID == null ? sentrescounter.find() : m_iID; // si casca que suba la excepcion hacia arriba.
