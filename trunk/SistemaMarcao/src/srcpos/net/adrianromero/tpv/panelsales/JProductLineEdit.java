...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private boolean init(AppView app, TicketLineInfo oLine) {
        ...
        m_jName.setEnabled(m_oLine.getProductReference() == null);
    ...
    private void initComponents() {
        ...
        m_jName = new net.adrianromero.editor.JEditorString();
        m_jUnits = new net.adrianromero.editor.JEditorDouble();
        m_jPrice = new net.adrianromero.editor.JEditorCurrency();
    ...
    private net.adrianromero.editor.JEditorString m_jName;
    private net.adrianromero.editor.JEditorCurrency m_jPrice;
    private net.adrianromero.editor.JEditorCurrency m_jPriceTax;
    private javax.swing.JLabel m_jSubtotal;
    private javax.swing.JLabel m_jTaxrate;
    private javax.swing.JLabel m_jTotal;
    private net.adrianromero.editor.JEditorDouble m_jUnits;
