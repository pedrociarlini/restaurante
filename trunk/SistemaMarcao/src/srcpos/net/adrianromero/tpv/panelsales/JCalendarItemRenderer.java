...
public class JCalendarItemRenderer extends javax.swing.JPanel implements ListCellRenderer, Serializable {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        if (value == null) {
            ...
            m_jTime.setText(Formats.TIME.formatValue(avalue[1]));
            m_jTitle.setText(Formats.STRING.formatValue(avalue[2]));
            m_jChairs.setText(Formats.INT.formatValue(avalue[3]));
            m_bDone = ((Boolean) avalue[4]).booleanValue();
            m_jDescription.setText(Formats.STRING.formatValue(avalue[5]));
        }
