...
public class JRefundLines extends javax.swing.JPanel {
    ...
    public JRefundLines(AppView oApp, JPanelTicketEdits jTicketEdit) {
        
        m_jTicketEdit = jTicketEdit;
        
        initComponents();
        
        ticketlines = new JTicketLines(oApp);
        //ticketlines.setPreferredSize(new java.awt.Dimension(15, 200));
        
        add(ticketlines, BorderLayout.CENTER);
    }
...
//        if (index >= 0) {
//            ProductOutInfo oLine = (ProductOutInfo) m_aLines.get(index);
//            if (oLine.getMultiply() < -1.0)
//                ProductOutInfo
//            
//            
...
//                if (e == null) {
//                    e = new ActionEvent(, ActionEvent.ACTION_PERFORMED, "ADDLINE");
//                }
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(0, 5, 0, 0)));
        jPanel2.setLayout(new java.awt.GridLayout(0, 1, 0, 5));

        m_jbtnAddOne.setText(AppLocal.getIntString("button.refundone"));
        ...
        m_jbtnAddLine.setText(AppLocal.getIntString("button.refundline"));
        ...
        m_jbtnAddAll.setText(AppLocal.getIntString("button.refundall"));
