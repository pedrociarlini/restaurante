...
public class PainelLabirinto extends JPanel {
	...
	/**
	 * Tamanho da área que valerá por um pixel.
	 */
	int pixel = 10;
	 ...
	 * 
	 * @param g
	 *            <code>Graphis</code> que será desehado.
	 */
	...
	/**
	 * Desenha todos os elmentos, baseado na matriz da simulação, representada
	...
	/**
	 * Os índices do array seguem a seguinte ordem: <br />
	...
	/**
	 * Retorna a cor relativa ao objeto que será desenhado na tela.
	 * 
	 * @param numGrid
	 * @return
	 */
